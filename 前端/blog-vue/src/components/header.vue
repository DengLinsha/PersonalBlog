	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/headbg05.jpg)'}">
		...
		<div class="h-information">
			...
			<h2 class="h-description">
                        ...
                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"在心里种花，人生才不会荒芜"}}
...
.headImgBox .scene span {
	...
	text-shadow: 2px 2px 0 rgb(253 183 205 / 80%), -2px -2px 0 rgb(134 224 255 / 80%);
  font-family: serif;
}
