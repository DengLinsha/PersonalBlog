...
import com.dls.domain.dto.CategoryDto;
import com.dls.domain.entity.Category;
import com.dls.domain.vo.CategoryVo;
import com.dls.domain.vo.ExcelCategoryVo;
...
public class CategoryController {
    ...
    public void export(HttpServletResponse response){
        try {
            ...
            //如果出现异常,就返回失败的json数据给前端。AppHttpCodeEnum和ResponseResult是写的类
            ResponseResult result = ResponseResult.errorResult(AppHttpCodeEnum.SYSTEM_ERROR);
            //WebUtils是的类，里面的renderString方法是将json字符串写入到请求体，然后返回给前端
